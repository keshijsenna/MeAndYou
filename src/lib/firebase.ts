...
export function syncMoods(onUpdate: (moodLogs: any[]) => void, onError: (err: any) => void) {
  if (!isFirebaseLive || !db) {
    ...
    const defaultHistory = [
      { dateStr: new Date('2026-03-24').toDateString(), displayDate: '24 Mar 2026', mood: "💖", label: "Dicintai", color: "#EBC2C6", note: "Hari jadian kita yang tak terlupakan!", userId: 'Nauraa' },
